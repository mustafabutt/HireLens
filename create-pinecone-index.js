...
async function createPineconeIndex() {
  ...
  try {
    ...
    // Create the index with minimal parameters
    ...
    if (error.message.includes('already exists')) {
      ...
      console.log('\n🔧 The index creation parameters are invalid.');
      console.log('This might be due to Pinecone API changes or incorrect parameters.');
      console.log('Try creating the index manually in the Pinecone console.');
    }
  }
}
